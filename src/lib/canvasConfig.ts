...
export const CATEGORIES: Record<NodeCategory, CategoryConfig> = {
  ...
  classic_ml: { id: "classic_ml", label: "Classic ML", accent: "#0ea5e9", description: "Full scikit-learn suite · CPU instant." },
  deep_learning: { id: "deep_learning", label: "Deep Learning", accent: "#8b5cf6", description: "Full PyTorch / Transformers · Colab GPU." },
...
export const NODE_PALETTE: PaletteItem[] = [
  // ── Data ─────────────────────────────────────────────────────────────────
  { type: "data:csv", label: "Custom CSV", description: "Upload your own dataset · auto-detect target", category: "data", icon: "FileSpreadsheet", accent: CATEGORIES.data.accent },
  ...
  { type: "data:synthetic", label: "Synthetic Classification", description: "Generated blobs · configurable shape & noise", category: "data", icon: "Boxes", accent: CATEGORIES.data.accent, params: [
  ...
  // ── Preprocessing ───────────────────────────────────────────────────────
  { type: "pre:scaler", label: "Standard Scaler", description: "Zero mean · unit variance", category: "preprocessing", icon: "Scale", accent: CATEGORIES.preprocessing.accent },
  ...
  { type: "ml:logistic", label: "Logistic Regression", description: "Linear · L1/L2 regularization", category: "classic_ml", icon: "Sigma", accent: CATEGORIES.classic_ml.accent, params: [
  ...
  { type: "ml:ridge", label: "Ridge Classifier", description: "Linear · L2 least squares", category: "classic_ml", icon: "Minus", accent: CATEGORIES.classic_ml.accent, params: [{ key: "alpha", label: "Alpha", value: 1.0 }] },
  { type: "ml:sgd", label: "SGD Classifier", description: "Linear · scalable online learning", category: "classic_ml", icon: "TrendingUp", accent: CATEGORIES.classic_ml.accent, params: [
  ...
  { type: "ml:naive_bayes", label: "Gaussian Naive Bayes", description: "Probabilistic · assumes independence", category: "classic_ml", icon: "Percent", accent: CATEGORIES.classic_ml.accent, params: [{ key: "var_smoothing", label: "Var smoothing", value: 1e-9 }] },
  { type: "ml:svm", label: "Support Vector Machine", description: "Margin maximizer · kernel methods", category: "classic_ml", icon: "Crosshair", accent: CATEGORIES.classic_ml.accent, params: [
    { key: "C", label: "C (regularization)", value: 1.0 },
  ...
  { type: "ml:decision_tree", label: "Decision Tree", description: "Rule-based · interpretable splits", category: "classic_ml", icon: "GitBranch", accent: CATEGORIES.classic_ml.accent, params: [
  ...
  { type: "ml:random_forest", label: "Random Forest", description: "Bagged trees · robust ensemble", category: "classic_ml", icon: "Network", accent: CATEGORIES.classic_ml.accent, params: [
  ...
  { type: "ml:hist_gradient_boosting", label: "Hist Gradient Boosting", description: "Native histogram boosting · fast", category: "classic_ml", icon: "BarChart3", accent: CATEGORIES.classic_ml.accent, params: [
  ...
  { type: "ml:lightgbm", label: "LightGBM", description: "Histogram gradient boosting · light", category: "classic_ml", icon: "Gauge", accent: CATEGORIES.classic_ml.accent, params: [
    { key: "n_estimators", label: "Estimators", value: 400 },
  ...
  { type: "dl:pytorch_mlp", label: "PyTorch MLP", description: "Multi-layer perceptron · custom loop", category: "deep_learning", icon: "BrainCircuit", accent: CATEGORIES.deep_learning.accent, params: [
  ...
  { type: "viz:metrics", label: "Evaluation Metrics", description: "Accuracy · precision · recall · F1 · ROC-AUC", category: "visualization", icon: "Activity", accent: CATEGORIES.visualization.accent },
  ...
  { type: "viz:scatter", label: "Scatter Explorer", description: "2D / 3D scatter · pair plot · decision boundary", category: "visualization", icon: "ScatterChart", accent: CATEGORIES.visualization.accent, params: [
    { key: "charts", label: "Scatter charts", kind: "charts", chartGroup: "scatter", value: "scatter_2d,decision_boundary" },
    { key: "projection", label: "Projection", value: "pca", options: ["pca", "features", "importance"], hint: "pca = principal components · features = pick indices below · importance = two strongest features" },
  ...
  { type: "viz:knn", label: "KNN Analyzer", description: "k sweep · neighbour links · vote share · distances", category: "visualization", icon: "CircleDot", accent: CATEGORIES.visualization.accent, params: [
  ...
  { type: "viz:diagnostics", label: "Model Diagnostics", description: "Learning curve · CV spread · calibration · correlation", category: "visualization", icon: "Stethoscope", accent: CATEGORIES.visualization.accent, params: [
