...
function Field({
  ...
  return (
    <label className="group/field block">
      <span className="nf-hud-label mb-2 flex items-center gap-1.5 text-neutral-400 dark:text-zinc-500">
        {icon}
        {label}
      </span>
      ...
      {hint ? <span className="mt-1.5 block text-[11px] text-neutral-400 dark:text-zinc-500">{hint}</span> : null}
    </label>
  );
}
        ...
        <div className="relative flex h-full flex-col justify-between px-10 py-9 xl:px-14">
          ...
          <div className="nf-auth-line flex items-center gap-2.5">
            <span className="relative flex h-11 w-11 items-center justify-center overflow-hidden rounded-xl border border-white/10 bg-white/[0.04]">
              <Image src="/datlify-mark.png" alt="" width={40} height={40} className="h-8 w-8 object-contain" />
            </span>
            <div>
              <p className="text-[15px] font-semibold tracking-tight text-white">Datlify</p>
              <p className="font-mono text-[9px] uppercase tracking-[0.3em] text-white/35">identity console</p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-x-5 gap-y-3">
            <div className="nf-metric-pop flex items-center gap-2 rounded-lg border border-white/[0.07] bg-white/[0.03] px-3 py-2">
              ...
              <div>
                ...
                <p className="nf-hud-label mt-1 text-white/35">val_loss</p>
              </div>
            </div>
            <div className="nf-metric-pop flex items-center gap-2 rounded-lg border border-white/[0.07] bg-white/[0.03] px-3 py-2 [animation-delay:120ms]">
              ...
              <div>
                ...
                <p className="nf-hud-label mt-1 text-white/35">val_acc</p>
              </div>
            </div>
            <div className="nf-metric-pop flex items-center gap-2 rounded-lg border border-white/[0.07] bg-white/[0.03] px-3 py-2 [animation-delay:240ms]">
              ...
              <div>
                ...
                <p className="nf-hud-label mt-1 text-white/35">epoch</p>
              </div>
            </div>
            <div className="font-mono text-[9px] uppercase tracking-[0.26em] text-white/30">
              GPU mesh <span className="text-emerald-400">●</span> online
            </div>
          </div>

          {/* Trust strip */}
          <div className="nf-auth-line flex flex-wrap items-center gap-x-6 gap-y-2 font-mono text-[9px] uppercase tracking-[0.26em] text-white/30 [animation-delay:300ms]">
            <span>SOC 2</span>
            <span>GDPR</span>
            <span>TLS 1.3</span>
      ...
      <main className="relative flex flex-1 items-center justify-center px-5 py-12 sm:px-8">
        ...
        <div className="relative w-full max-w-md">
          ...
          <div className="nf-auth-line mb-8 flex items-center justify-center gap-2 lg:hidden">
            <Image src="/datlify-mark.png" alt="Datlify" width={34} height={34} className="h-8 w-8" />
            <span className="text-base font-semibold tracking-tight text-white">Datlify</span>
          </div>
          ...
          <div className="glass-card overflow-hidden rounded-3xl shadow-[0_60px_160px_-60px_rgba(0,0,0,0.9)]">
            ...
            <div className="border-b border-white/[0.06] px-7 pb-6 pt-8">
              <p className="nf-hud-label text-white/40">DATLIFY // IDENTITY</p>
            ...
            <div className="px-7 py-7">
              ...
              <div className="my-6 flex items-center gap-3">
                ...
                <span className="font-mono text-[9px] uppercase tracking-[0.24em] text-white/35">or continue with email</span>
                <span className="h-px flex-1 bg-white/[0.07]" />
              </div>
              ...
              <form key={mode} onSubmit={handleSubmit} className="nf-auth-flip flex flex-col gap-4">
                ...
                {mode === "signup" && password.length > 0 ? (
                  <div>
                    ...
                    <p className="mt-1.5 font-mono text-[9px] uppercase tracking-[0.2em] text-white/35">{strengthLabel}</p>
                  </div>
                ) : null}

                {mode === "signin" ? (
                  <div className="flex items-center justify-between">
                    <Link href="/forgot-password" className="font-mono text-[10px] uppercase tracking-[0.16em] text-sky-400/80 transition-colors hover:text-sky-300">
                      Forgot password?
                    </Link>
                    <span className="font-mono text-[10px] uppercase tracking-[0.16em] text-white/30">NF:// secure</span>
                  </div>
                ) : null}
          ...
          <div className="nf-auth-line mt-6 flex flex-col items-center gap-3 [animation-delay:200ms]">
            ...
            <Link href="/" className="font-mono text-[10px] uppercase tracking-[0.2em] text-white/30 transition-colors hover:text-white">
              ← Back to home
            </Link>
          </div>
        </div>
